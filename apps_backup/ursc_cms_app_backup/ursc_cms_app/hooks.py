...
app_logo_url = "/assets/ursc_cms_app/images/logo.png"
app_favicon = "/assets/ursc_cms_app/images/logo.png"
...
CORE_DTYPES = [
    ...
    # SRV Doctypes
    "SRV ENTRY", "SRV ENT TABLE",
    "SRV BINNING", "SRV BIN TABLE",
    "SRV_POST", "SRV POST RE",
]
...
doctype_js = {
    ...
    "SRV ENTRY": "public/js/srv_entry.js",
...
doc_events = {
    ...
    "Purchase Order": {
        #po no need to map the fields
        #"before_save": "ursc_cms_app.api.map_mr_custom_fields",
    ...
    #Stock Entry": {
     #   "validate": "ursc_cms_app.api.populate_mdb_part_no",
      #  "validate": "ursc_cms_app.api.validate_expiry_date",
       # "before_submit": "ursc_cms_app.api.validate_expiry_date",
        #"on_submit": "ursc_cms_app.api.update_item_status_quality_checked"

    #},'''
        "Stock Entry": {
        "validate": [
            "ursc_cms_app.api.populate_mdb_part_no",
            "ursc_cms_app.api.validate_expiry_date",
        ],
        "before_submit": "ursc_cms_app.api.validate_expiry_date",
        "on_submit": "ursc_cms_app.api.update_item_status_quality_checked"
    },
        "Purchase Receipt": {
        "on_submit": "ursc_cms_app.api.set_pr_item_status_to_be_screened"
    },
    #"Stock Entry": {
    #},
        "Purchase Invoice": {
        "before_save": "ursc_cms_app.api.map_bill_no_to_custom"
    }
}
# Override standard DocType class with custom class
override_doctype_class = {
    "Purchase Order": "ursc_cms_app.overrides.purchase_order.CustomPurchaseOrder"
}

# Override whitelisted methods
override_whitelisted_methods = {
    "erpnext.buying.doctype.purchase_order.purchase_order.make_purchase_receipt": 
        "ursc_cms_app.api.custom_pr_from_po",
    
    "erpnext.accounts.doctype.purchase_invoice.purchase_invoice.make_purchase_receipt": 
        "ursc_cms_app.api.custom_pr_from_pi"
    
    # If you want to switch to the no-SRV-number version, uncomment below and comment the above line:
    # "erpnext.accounts.doctype.purchase_invoice.purchase_invoice.make_purchase_receipt":
    #     "ursc_cms_app.api.custom_make_purchase_receipt"
}

# DocType-specific event hooks
doc_events = {
    "Purchase Invoice": {
        "validate": "ursc_cms_app.api.validate_supplier_items"
    },
...
#       "ursc_cms_app.tasks.all"
 
#   ],
 
#   "daily": [
 
#       "ursc_cms_app.tasks.daily"
 
#   ],
 
#   "hourly": [
 
#       "ursc_cms_app.tasks.hourly"
 
#   ],
 
#   "weekly": [
 
#       "ursc_cms_app.tasks.weekly"
 
#   ],
 
#   "monthly": [
 
#       "ursc_cms_app.tasks.monthly"
