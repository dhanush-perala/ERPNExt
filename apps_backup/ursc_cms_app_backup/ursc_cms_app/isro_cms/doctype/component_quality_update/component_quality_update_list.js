...
// frappe.ui.form.on("Component_Quality_Update", {
// 	refresh(frm) {

// 	},
// });
frappe.listview_settings['COMPONENT QUANTITY UPDATE'] = {
        ...
        if (!listview.active_filter_applied) {
            ...
            if (!hasFilter) {
                listview.filter_area.add([
                    ['COMPONENT QUANTITY UPDATE', 'status', '=', 'Active']
                ]);
            }
        }
    }
