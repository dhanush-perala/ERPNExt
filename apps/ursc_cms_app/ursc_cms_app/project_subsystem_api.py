    ...
    try:
        if frappe.request.method == "GET":
            ...
            if action == "get_projects":
                ...
                records = frappe.get_all("ADD PROJECT SUBSYSTEM", fields=["name", "project", "select_sub_system", "centre"])
                ...
                doc = frappe.get_doc({
                    ...
                    "select_sub_system": data["sub_system"],
                    "centre": data["centre"]
                })
                ...
                doc.select_sub_system = data["sub_system"]
